<template>
  <el-table :data="state.table" stripe border style="width: 60%; background-color: azure">
    ...
    <el-table-column prop="train_id" label="ID" sortable width="100" />
    <el-table-column prop="departure" label="Name" sortable width="100" />
    <el-table-column prop="terminal" label="Password" sortable width="100" />
    <el-table-column prop="l_time" label="Type" sortable width="100" />
    <el-table-column prop="a_time" label="ID" sortable width="100" />
    <el-table-column prop="first_ticket" label="Name" sortable width="100" />
    <el-table-column prop="first_cost" label="Password" sortable width="100" />
    <el-table-column prop="second_ticket" label="Type" sortable width="100" />
    <el-table-column prop="second_ti" label="Type" sortable width="100" />
